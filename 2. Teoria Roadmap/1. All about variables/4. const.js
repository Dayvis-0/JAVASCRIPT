/*La declaracion const declara variables locales con alcance de bloque. El valor 
de una constante no se puede cambiar mediante la reasignación mediante el operador 
de asignación, pero si una constante es un objeto, sus propiedades se pueden 
agregar, actualiza o eliminar. Las declaraciones const tienen como alcance tanto 
los bloques como las funciones
Sintaxis:
const name1 = value1;
...
/*Una const inicia declaraciones, no sentencias. Esto significa que no se puede 
usar una sola declaracion const como cuerpo de un bloque (lo cual tiene sentido, ya
que no hay forma de acceder a la variable)*/
console.log(number);
// if (true) const a = 1; Error

/*Se requiere un inicializador para una const. Debe especificar su valor en la 
