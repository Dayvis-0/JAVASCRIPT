...
Se dice que una variable declarada con let, const o class, esta en una "zona muerta 
temporal" desde el inicio del bloque hasta que la ejecucion de codigo llega al lugar 
donde se declara e inicializa la variable*/
...
// Esto difiere del uso de typeof para variables no declaradas y variables que 
// contienen un valor indefinido
console.log(typeof undeclaredVariable);

/*Nota: Las declaraciones let y const solo se procesan cuando se procesa el script 
actual. Si tiene dos elementos <script> dentro de un HTML, el primer script no esta 
sujeto a las restricciones de TDZ para las variables let o const de nivel superior 
declaradas en el segundo script. Sin embargo, si declara una variable let o const
en el primer script, volver a declararla en el segundo generara un error de redeclaracion

Las declaraciones let no pueden estar en el mismo ambito que cualquier otra declaracion, 
incluidas las declaraciones let, const, class, function, var e import*/
...
// Una declaracion let dentro del cuerpo de una funcion no puede tener el mismo nombre 
// que un parametro
function foooo(aPara) {
    // let aPara = 1;
}
// Una declaracion let dentro de un bloque catch no puede tener el mismo nombre que 
// el identificador asociado a catch
try {
} catch (ePara) {
    // let ePara = 1;
}
...
/* Reglas de alcance 
Las variables declaradas por let tienen su ámbito en el bloque para el que se declaran, 
así como en cualquier subbloque que contenga. De esta manera, let funciona de forma 
muy similar a var. La principal diferencia radica en que el ámbito de una variable 
var es la función que la contiene en su totalidad:*/
function varTest() {
    var xVar = 1;
    {
...
// En el nivel superior de programas y funciones, let a diferencia de var, no crea una 
...
/*Este fenómeno puede resultar confuso en una situación como la siguiente. La instrucción 
