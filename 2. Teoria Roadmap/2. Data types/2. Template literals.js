...
cadenas la sustitución de marcadores de posición). Sin embargo, un literal de plantilla 
de etiquetado no puede generar una cadena; se puede usar con una función de etiqueta 
personalizada para realizar las operaciones que se deseen en las diferentes parte del 
...
lenguaje que no lo interprete con su significado habitual, sino que lo trate como un 
texto literal.*/
if (`\`` === "`") {
    console.log("`\\`` === \"`\" = " + true);
}
...
marcador de posición ${expresion} dentro de una plantilla. 

Por ejemplo, sin literales de plantilla, si quisiera devolver un valor predeterminado 
en función de una condición particular, podria hacer lo siguiente.*/
console.log("\nPlantillas de anidamiento");
