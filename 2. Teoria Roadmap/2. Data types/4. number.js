/* El tipo de dato Número en JS representa números de punto flotante, como 
37 o -9.57 El constructor Number contiene constantes y métodos para 
trabajar con números. Los valores de otros tipos se puede convertir en 
números mediante la función Number()*/
const number1 = 255;
const number2 = 255.0;
...
/* Cuando se usa como función, Number(valor) convierte una cadena u otro 
valor al tipo Número. Si el valor no se puede convertir, devuelve NaN*/
console.log("\n")
...
Los operadores bit a bit siempre convierten los operandos en enteros de 32 
bits. en estos casos, tras convertir el valor a un número este se normaliza 
al ancho dado truncando primero la parte fraccionaria y luego tomando los 
...
// El número positivo representable más pequeño, es decir, el número positivo 
// más cercano a cero (sin ser realmente cero)
console.log(`Number.MIN_VALUE -> ${Number.MIN_VALUE}`);
// Valor especial que representa el infinito negativo. Se devuelve en caso 
// de desbordamiento
console.log(`Number.NEGATIVE_INFINITY -> ${Number.NEGATIVE_INFINITY}`);
// Valor especial que representa el infinito. Se devuelve en aso de 
// desbordamiento
...
/* Esto es lo mismo que la funcion parseFloat(). parseFloat() analiza un 
argumento de cadena y devuelve un numero de punto flotante. Si no puede 
analizar un número a partir de un argumento, devuelve NaN*/
...
/* Esto es lo mismo que la función global parseInt(). Analiza un argumento 
de cadena y devuelve un entero de la base o el radio especificado*/
